...
@Component({
  selector: 'app-inputfavorite',
  templateUrl: './inputfavorite.component.html',
  styleUrls: ['./inputfavorite.component.css']
})
export class InputfavoriteComponent implements OnInit {
  ...
  // Variable that checks whether local storage is empty or not
  isEmpty: boolean;
  inputData: any;
  ...
  // Just using city and state response, we fetch new daily information when
  // image on favotie table is clicked
